...
public class Student_Controller extends Configs implements Initializable {
    ...
    public void table(TextField txt_f) {
       String  groupNumber = txt_f.getText();
        Connect();
        ...
        try (PreparedStatement pst = con.prepareStatement
                ("SELECT subject_name, group_number, week_day, week_type, start_time, end_time, teachers_name " +
                        ...
                        "JOIN students.дисциплины " +
                        "ON расписание.id_distsipliny = дисциплины.id_distsipliny " +
                        "JOIN students.преподаватели ON дисциплины.id_prepodavatelya = преподаватели.id_prepodavatelya " +
                        "JOIN students.группы ON расписание.id_gruppy = группы.id_gruppy " +
                        "WHERE group_number = ?")) {
            pst.setString(1, groupNumber);
